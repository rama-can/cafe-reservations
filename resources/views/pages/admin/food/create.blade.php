        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-xl items-center mx-auto">
                    <section>
                    <x-form-section action="{{ route('admin.foods.store') }}" enctype="multipart/form-data">
                            <x-slot name="title">
                                {{ __('Food') }}
                            </x-slot>

                            <x-slot name="description">
                                {{ __("Add new food information") }}
                            </x-slot>
                            ...
                            <x-slot name="form">
                                ...
                                <div class="col-span-6 sm:col-span-6">
                                    ...
                                    <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name')" required autofocus autocomplete="name" placeholder="name"/>
