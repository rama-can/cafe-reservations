<x-admin-layout>@section('title'){{ __('Food Categories') }}@endsection
    <x-slot name="header">
                                ...
                                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                    <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                                        <div x-data="{ categoryId: null }">
                                            ...
                                            <x-modal name="confirm-category-deletion" :show="$errors->categoryDeletion->isNotEmpty()" focusable :maxWidth="'lg'">
                                                <form :action="'{{ route('admin.categories.destroy', '') }}' + '/' + categoryId" class="p-6" method="POST">
                                                    @csrf
                                                    @method('DELETE')
