        ...
        <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('login') }}">
            ...
            <div class="mt-4">
                ...
                <div class="relative flex-1 col-span-4" x-data="{ show: true }">
                    <input class="w-full text-sm border-slate-300 bg-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                            id="password"
